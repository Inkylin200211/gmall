...
public class SpuController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("pms:spu:list")
    ...
    //@RequiresPermissions("pms:spu:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("pms:spu:save")
    ...
    //@RequiresPermissions("pms:spu:update")
    ...
    //@RequiresPermissions("pms:spu:delete")
