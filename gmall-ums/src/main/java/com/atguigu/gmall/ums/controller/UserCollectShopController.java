...
public class UserCollectShopController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("ums:usercollectshop:list")
    ...
    //@RequiresPermissions("ums:usercollectshop:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("ums:usercollectshop:save")
    ...
    //@RequiresPermissions("ums:usercollectshop:update")
    ...
    //@RequiresPermissions("ums:usercollectshop:delete")
